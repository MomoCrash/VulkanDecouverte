...
RenderPipeline::RenderPipeline(std::vector<Shader*> shaders, RenderWindow const& window)
{
...
RenderPipeline::RenderPipeline(std::vector<Shader*> shaders, RenderWindow const& window, RenderTarget const& target)
{
    ...
    pipelineInfo.pColorBlendState = &colorBlending;
    pipelineInfo.pDynamicState = &dynamicState;
    pipelineInfo.layout = target.getPipelineLayout();
    pipelineInfo.renderPass = window.getRenderPass();
    pipelineInfo.subpass = 0;
    pipelineInfo.basePipelineHandle = VK_NULL_HANDLE; // Optional
    pipelineInfo.basePipelineIndex = -1; // Optional
